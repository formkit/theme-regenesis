  ...
  inputs: {
    ...
    "family:button": {
      ...
      input: `
        ...
        ${"" /* dark mode styles */}
        dark:disabled:border-$colorTemperature-100 dark:disabled:bg-$colorTemperature-500 dark:disabled:text-$colorTemperature-200 dark:ring-offset-$primaryColor-300
      `,
    ...
    "family:box": {
      ...
      decorator: `
        ${"" /* base styles */}
        mr-1.5 bg-white ring-$primaryColor-400 peer-checked:border-$primaryColor-500 relative block w-$spacing(5,1,6) aspect-square border border-$colorTemperature-$borderShadeLightMode text-transparent ring-offset-2 peer-checked:text-$primaryColor-500 peer-focus-visible:ring-2 select-none group-data-[disabled]:!cursor-not-allowed group-data-[disabled]:bg-$colorTemperature-100 group-data-[disabled]:grayscale $inputShadow group-data-[disabled]/listoption:cursor-not-allowed

        ${"" /* dark mode styles */}
        dark:border-$colorTemperature-$borderShadeDarkMode dark:bg-transparent dark:group-data-[disabled]:bg-$colorTemperature-700 dark:ring-offset-$primaryColor-300 dark:peer-focus-visible:ring-1
      `,
      decoratorIcon:
      ...
      `,
      optionHelp:
        "text-$colorTemperature-500 text-$textSize(-2,*) mt-$spacing(-3)",
    ...
    "family:text": {
      ...
      inner: `
        ${"" /* base styles */}
        text-$textSize flex items-center w-full mb-$spacing(-1) py-$spacing px-$spacing(1) $borderRadius border border-$colorTemperature-$borderShadeLightMode bg-white focus-within:ring-1 focus-within:!ring-$primaryColor-400 focus-within:!border-$primaryColor-400 group-data-[invalid]:border-red-500 group-data-[invalid]:ring-1 group-data-[invalid]:ring-red-500 group-data-[disabled]:bg-$colorTemperature-100 group-data-[disabled]:!cursor-not-allowed $inputShadow
      ...
      input: `
        ${"" /* base styles */}
        text-$textSize text-$colorTemperature-700 min-w-0 grow outline-none bg-transparent selection:bg-$primaryColor-100 placeholder:text-$colorTemperature-400 group-data-[disabled]:!cursor-not-allowed
    ...
    range: {
      ...
      input: `
        ...
        ${"" /* webkit styles - track */}
        [&::-webkit-slider-runnable-track]:bg-$colorTemperature-$borderShadeLightMode(0,300,500)/50 [&::-webkit-slider-runnable-track]:h-$spacing(-1,1,1.5) [&::-webkit-slider-runnable-track]:min-h-[0.25em] ::-webkit-slider-runnable-track]:max-h-[1em] [&::-webkit-slider-runnable-track]:$borderRadius

        dark:[&::-webkit-slider-runnable-track]:bg-$colorTemperature-$borderShadeDarkMode(0,400,600)/50

        ${"" /* webkit styles - thumb */}
        [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-$spacing(3,2,5) [&::-webkit-slider-thumb]:aspect-square [&::-webkit-slider-thumb]:bg-$primaryColor-500 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:relative [&::-webkit-slider-thumb]:top-1/2 [&::-webkit-slider-thumb]:-translate-y-1/2 [&::-webkit-slider-thumb]:group-data-[disabled]:bg-$colorTemperature-500 [&::-webkit-slider-thumb]:group-data-[disabled]:!ring-$colorTemperature-$borderShadeLightMode(-1,200,400) [&::-webkit-slider-thumb]:focus-visible:ring-2 [&::-webkit-slider-thumb]:focus:!ring-$primaryColor-400 [&::-webkit-slider-thumb]:focus:ring-offset-2 [&::-webkit-slider-thumb]:$inputShadow dark:[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-$colorTemperature-$borderShadeDarkMode(1,500,700) dark:[&::-webkit-slider-thumb]:focus:ring-offset-$colorTemperature-700

        ${"" /* moz styles - track */}
        [&::-moz-range-track]:bg-$colorTemperature-$borderShadeLightMode(0,300,500)/50 [&::-moz-range-track]:h-$spacing(-1,1,1.5) [&::-moz-range-track]:min-h-[0.25em] [&::-moz-range-track]:max-h-[1em] [&::-moz-range-track]:$borderRadius

        dark:[&::-moz-range-track]:bg-$colorTemperature-$borderShadeDarkMode(0,400,600)/50

        ${"" /* moz styles - thumb */}
        [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:border-none [&::-moz-range-thumb]:w-$spacing(3,2,5) [&::-moz-range-thumb]:h-$spacing(3,2,5) [&::-moz-range-thumb]:bg-$primaryColor-500 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:group-data-[disabled]:bg-$colorTemperature-500 [&::-moz-range-thumb]:group-data-[disabled]:!ring-$colorTemperature-300 [&::-moz-range-thumb]:focus-visible:ring-2 [&::-moz-range-thumb]:focus:!ring-$primaryColor-400 [&::-moz-range-thumb]:focus:ring-offset-2 [&::-moz-range-thumb]:$inputShadow dark:[&::-moz-range-thumb]:group-data-[disabled]:!ring-$colorTemperature-500 dark:[&::-moz-range-thumb]:focus:ring-offset-$colorTemperature-700
      `,
    },
    select: {
      ...
      inner: `
        ${"" /* base styles */}
        relative flex items-center bg-white border border-$colorTemperature-$borderShadeLightMode $borderRadius focus-within:ring-1 focus-within:!ring-$primaryColor-400 focus-within:!border-$primaryColor-400 group-data-[invalid]:border-red-500 group-data-[invalid]:ring-1 group-data-[invalid]:ring-red-500 group-data-[disabled]:bg-$colorTemperature-100 group-data-[disabled]:!cursor-not-allowed $inputShadow group-data-[multiple]:$borderRadius(0,rounded-none,rounded-2xl)
      ...
      input: `
        ${"" /* base styles */}
        grow p-$spacing pr-[2em] text-$textSize text-$colorTemperature-700 text-ellipsis min-w-0 outline-none bg-transparent group-data-[disabled]:!cursor-not-allowed group-data-[prefix-icon]:!pl-0 group-data-[suffix-icon]:!pr-0 data-[placeholder]:text-$colorTemperature-400 group-data-[multiple]:!p-0 selection:bg-$primaryColor-100
    ...
    textarea: {
      inner:
        "flex items-center mb-$spacing(-1) bg-white border border-$colorTemperature-$borderShadeLightMode $borderRadius(0,rounded-none,rounded-2xl) focus-within:ring-1 focus-within:!ring-$primaryColor-400 focus-within:!border-$primaryColor-400 group-data-[invalid]:border-red-500 group-data-[invalid]:ring-1 group-data-[invalid]:ring-red-500 group-data-[disabled]:bg-$colorTemperature-100 $inputShadow dark:border-$colorTemperature-$borderShadeDarkMode dark:group-data-[disabled]:bg-$colorTemperature-800/5 dark:group-data-[invalid]:border-red-400 dark:group-data-[invalid]:ring-red-400 dark:bg-transparent",
      input: `
        ${"" /* base styles */}
        text-$textSize(-1,*) h-$spacing(16,*) text-$colorTemperature-700 min-w-0 grow shrink !p-$spacing outline-none bg-transparent selection:bg-$primaryColor-100 placeholder:text-$colorTemperature-400 group-data-[disabled]:!cursor-not-allowed
    ...
    "family:dropdown": {
      ...
      inner: `
        ${"" /* base styles */}
        relative flex items-center bg-white border border-$colorTemperature-$borderShadeLightMode $borderRadius focus-within:ring-1 focus-within:!ring-$primaryColor-400 focus-within:!border-$primaryColor-400 group-data-[invalid]:border-red-500 group-data-[invalid]:ring-1 group-data-[invalid]:ring-red-500 group-data-[disabled]:bg-$colorTemperature-100 group-data-[disabled]:!cursor-not-allowed $inputShadow
      ...
      input: `
        ${"" /* base styles */}
        grow p-$spacing pr-0 text-$textSize text-$colorTemperature-700 text-ellipsis min-w-0 outline-none bg-transparent group-data-[disabled]:!cursor-not-allowed group-data-[prefix-icon]:!pl-0 group-data-[suffix-icon]:!pr-0 placeholder:text-$colorTemperature-400 selection:bg-$primaryColor-100
      ...
      `,
      listboxButton:
        "w-[2.5em] self-stretch text-$textSize flex items-center text-$colorTemperature-700 z-10 dark:text-$colorTemperature-300",
      removeSelection:
        "w-[2.5em] self-stretch text-$textSize flex items-center text-$colorTemperature-700 hover:text-red-400 z-10 dark:text-$colorTemperature-300",
      selectIcon:
      ...
      listbox:
        "bg-white $borderRadius(0,rounded-none,rounded-2xl) $inputShadow(2,shadow-md,shadow-2xl) overflow-clip dark:bg-$colorTemperature-700",
      listitem:
        "relative flex items-center px-$spacing py-$spacing(-1,1) first:pt-$spacing last:pb-$spacing text-$colorTemperature-700 text-$textSize aria-selected:text-white aria-selected:bg-$primaryColor-500 hover:bg-$primaryColor-100 dark:text-$colorTemperature-200 dark:hover:text-$colorTemperature-700 dark:aria-selected:text-white",
      selectedIcon:
      ...
      tagLabel: "mr-1",
      emptyMessage:
        "flex items-center px-$spacing py-$spacing(-1,1) first:pt-$spacing last:pb-$spacing text-$colorTemperature-700 text-$textSize(-1,*) aria-selected:text-white aria-selected:bg-$primaryColor-500",
    },
    autocomplete: {
      ...
      selectionWrapper:
        "bg-$colorTemperature-100 $borderRadius group-data-[multiple]:border group-data-[multiple]:border-$colorTemperature-$borderShadeLightMode(-1,200,600) group-data-[multiple]:mb-$spacing(-1,0.5,2) dark:bg-$colorTemperature-600 dark:group-data-[multiple]:border-$colorTemperature-$borderShadeDarkMode(0,300,700)",
      selection:
        "$borderRadius just pl-$spacing [&>*]:ml-0 dark:text-$colorTemperature-200",
    },
    colorpicker: {
      ...
      valueString:
        "text-$textSize text-$colorTemperature-700 selection:bg-$primaryColor-100 font-mono inline-block ml-$spacing mr-$spacing(-2) dark:text-$colorTemperature-300 dark:selection:text-$colorTemperature-700",
      panel: `
        ${"" /* base styles */}
      ...
      eyeDropper:
        "[grid-area:e] w-[2em] ml-$spacing inline-flex self-center justify-center justify-self-center aspect-square $borderRadius(0,rounded-none,rounded-2xl) border border-$colorTemperature-$borderShadeLightMode(-1) cursor-pointer content-center items-center text-$colorTemperature-600 dark:border-$colorTemperature-$borderShadeDarkMode(1)",
      ...
      fieldGroup: `
        ...
        ${"" /* nested input styles */}
        [&>input]:p-1 [&>input]:text-$textSize(-1) [&>input]:text-$colorTemperature-700 [&>input]:selection:bg-$primaryColor-100 [&>input]:m-0 [&>input]:grow [&>input]:shrink [&>input]:w-full [&>input]:border [&>input]:border-$colorTemperature-$borderShadeLightMode(-1) [&>input]:$borderRadius [&>input]:text-center [&>input]:appearance-none [&>input::-webkit-outer-spin-button]:appearance-none  [&>input::-webkit-inner-spin-button]:appearance-none [&>input::-webkit-inner-spin-button]:m-0 [&>input:focus]:outline-none [&>input:focus]:ring-1 [&>input:focus]:ring-$primaryColor-500 [&>input:focus]:border-$primaryColor-500 max-[431px]:[&>input]:text-base
      `,
      fieldLabel:
      ...
      swatchGroupLabel:
        "ml-1 block w-full text-$textSize(-1,xs,sm) text-$colorTemperature-500 dark:text-$colorTemperature-400",
      swatch: `
        ${"" /* base styles */} 
        ...
        ${"" /* canvas styles */}
        [&>canvas]:block [&>canvas]:w-full [&>canvas]:aspect-square [&>canvas]:$borderRadius [&>canvas:focus-visible]:outline-none [&>canvas:focus-visible]:ring-2 [&>canvas:focus-visible]:ring-$primaryColor-400 [&>canvas:focus-visible]:ring-offset-2 [&>canvas:focus-visible]:ring-offset-white dark:[&>canvas:focus-visible]:ring-offset-$colorTemperature-700
      `,
    },
    datepicker: {
      inner: "relative pl-0",
      ...
      calendarIcon:
        "text-$colorTemperature-600 focus-visible:text-$primaryColor-500 flex w-[1em] grow-0 shrink-0 self-stretch select-none [&>svg]:w-full [&>svg]:m-auto [&>svg]:max-h-[1em] [&>svg]:max-w-[1em]",
    },
    dropdown: {
      // inherits family:dropdown classes
      placeholder:
      ...
      selector: `
        ${"" /* base styles */}
        flex grow justify-between w-full p-$spacing pr-0 text-$textSize text-$colorTemperature-700 text-left group-data-[disabled]:!cursor-not-allowed group-data-[prefix-icon]:!pl-0 group-data-[suffix-icon]:!pr-0 data-[placeholder]:text-$colorTemperature-400 selection:bg-$primaryColor-100
      ...
      truncationCount:
        "flex items-center justify-center h-[1.5em] $borderRadius bg-$colorTemperature-400 text-white whitespace-nowrap text-$textSize(-3,*) tracking-tighter leading-0 py-$spacing(-4,1,1.5) px-$spacing(-2,1,1.5) shrink-0 my-auto",
    },
    mask: {
      // inherits family:text classes
      inner: "relative",
    ...
    repeater: {
      ...
      fieldset:
        "p-$spacing(1) border border-$colorTemperature-$borderShadeLightMode(-1,200,600) $borderRadius(0,rounded-none,rounded-2xl) group-data-[invalid]/repeater:border-red-500 group-data-[invalid]/repeater:border-2 dark:border-$colorTemperature-$borderShadeDarkMode(1,300,700)",
      legend: "px-$spacing(-2)",
      ...
      item: "flex w-full mb-$spacing bg-transparent rounded border border-$colorTemperature-$borderShadeLightMode(-1,200,600) overflow-clip $borderRadius(0,rounded-none,rounded-2xl) $inputShadow [&_.formkit-outer_.formkit-inner]:!shadow-none dark:border-$colorTemperature-$borderShadeDarkMode(1,300,700)",
    ...
    slider: {
      ...
      fill: "h-full rounded-full absolute top-0 -mx-1 bg-$primaryColor-500 group-data-[disabled]:bg-$colorTemperature-500",
      marks: "absolute pointer-events-none inset-0",
      mark: 'absolute top-1/2 w-[3px] h-[3px] rounded-full -translate-x-1/2 -translate-y-1/2 bg-$colorTemperature-$borderShadeLightMode(0,300,500) data-[active="true"]:bg-white',
      markLabel:
    ...
    toggle: {
      outer: "max-w-none",
      altLabel:
        "block w-full mb-$spacing(-1) font-bold text-$textSize(-2,*) text-$colorTemperature-700 dark:text-$colorTemperature-300",
      ...
      track:
        "p-0.5 min-w-[3em] relative cursor-pointer select-none rounded-full transition-all bg-$colorTemperature-400 peer-checked:bg-$primaryColor-500 peer-checked:[&>div:last-child]:left-full peer-checked:[&>div:last-child]:-translate-x-full peer-checked:[&>div:first-child:not(:last-child)]:left-0 peer-checked:[&>div:first-child:not(:last-child)]:translate-x-0 $inputShadow(-1,*) peer-focus-visible:ring-2 peer-focus-visible:ring-$primaryColor-400 peer-focus-visible:ring-offset-2 dark:bg-$colorTemperature-500",
      valueLabel:
        "font-bold text-$textSize(-2,*) text-$colorTemperature-700 dark:text-$colorTemperature-300",
    ...
    transferlist: {
      ...
      help: "pb-$spacing",
      transferlist:
        "grow shrink min-w-0 $inputShadow aspect-[4/5] flex flex-col min-h-[350px] border border-$colorTemperature-$borderShadeLightMode(-1,200,900) $borderRadius(0,rounded-none,rounded-2xl) overflow-hidden select-none dark:border-$colorTemperature-$borderShadeDarkMode(1,100,800) dark:bg-$colorTemperature-900/50",
      transferlistHeader:
        "flex bg-$colorTemperature-100 text-$colorTemperature-600 text-$textSize(-1,*) justify-between items-center border-b border-$colorTemperature-$borderShadeLightMode(-1,200,900) py-$spacing px-$spacing(1) dark:bg-$colorTemperature-700 dark:border-$colorTemperature-$borderShadeDarkMode(1,100,800) dark:text-$colorTemperature-400",
      transferlistHeaderItemCount:
        "ml-auto text-xs min-w-[1.5em] [line-height:1.5em] px-$spacing text-center $borderRadius(2) bg-$colorTemperature-200 text-$colorTemperature-700 dark:bg-$colorTemperature-500 dark:text-$colorTemperature-300",
      transferlistListItems:
        "list-none bg-white h-full overflow-x-hidden overflow-y-auto dark:bg-transparent",
      transferlistListItem: `py-$spacing px-$spacing pl-[1.5em] relative text-$colorTemperature-700 aria-selected:!bg-$primaryColor-600 border-$colorTemperature-$borderShadeLightMode(-2,200,400) aria-selected:!text-white first:-mt-px first:border-t flex border-b aria-selected:border-$primaryColor-$borderShadeLightMode(-2,400,600) bg-white data-[is-active=true]:text-$primaryColor-500 data-[is-active=true]:bg-$colorTemperature-100 cursor-pointer group-data-[is-max=true]:cursor-not-allowed items-center 
      
      dark:bg-$colorTemperature-800 dark:text-$colorTemperature-300 dark:border-$colorTemperature-$borderShadeDarkMode(2,400,600) dark:aria-selected:border-$primaryColor-400`,
      transferlistOption: "text-$textSize(-1,*)",
      transferControls:
        "inline-flex grow-0 shrink border border-$colorTemperature-$borderShadeLightMode(-1,200,900) flex-row sm:flex-col justify-center my-$spacing sm:my-auto mx-auto sm:mx-$spacing $borderRadius overflow-clip $inputShadow(-2) dark:border-$colorTemperature-$borderShadeDarkMode(3,100,800)",
      sourceEmptyMessage:
      ...
      transferlistSearch:
        "flex border border-$colorTemperature-$borderShadeLightMode(-1,200,900) $borderRadius items-center text-$colorTemperature-700 selection:bg-$primaryColor-100 dark:bg-$colorTemperature-700 dark:border-$colorTemperature-$borderShadeDarkMode(1,100,800) dark:text-$colorTemperature-300 dark:selection:bg-$primaryColor-100 dark:selection:text-$colorTemperature-700 dark:bg-$colorTemperature-800",
      ...
      transferlistButton: `
        sm:w-5 flex justify-center text-$textSize(-2) shrink-0 box-content text-$colorTemperature-700 disabled:bg-$colorTemperature-200 disabled:!text-$colorTemperature-400 bg-$colorTemperature-50 hover:text-$primaryColor-500 cursor-pointer appearance-none border-none p-$spacing(2) hover:z-10 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:text-current disabled:hover:outline-none

        dark:bg-$colorTemperature-800 dark:text-$colorTemperature-400 dark:hover:text-$primaryColor-400 dark:disabled:!text-$colorTemperature-600 dark:disabled:bg-$colorTemperature-900 dark:disabled:hover:text-current dark:disabled:hover:outline-none dark:hover:text-$primaryColor-400
      `,
      fastForwardIcon:
