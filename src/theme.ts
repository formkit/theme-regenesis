  ...
  inputs: {
    ...
    "datetime-local": {
      ...
      input: `
        ...
        focus:[&::-webkit-datetime-edit-month-field]:bg-$accentColor-100
        focus:[&::-webkit-datetime-edit-year-field]:bg-$accentColor-100
        focus:[&::-webkit-datetime-edit-hour-field]:bg-$accentColor-100
        focus:[&::-webkit-datetime-edit-minute-field]:bg-$accentColor-100
        focus:[&::-webkit-datetime-edit-ampm-field]:bg-$accentColor-100
      `,
    },
    file: {
      // inherits family:text classes
    ...
    week: {
      // inherits family:text classes
      input: `
        focus:[&::-webkit-datetime-edit-week-field]:bg-$accentColor-100
        focus:[&::-webkit-datetime-edit-year-field]:bg-$accentColor-100
      `,
    },
    ...
    mask: {
      ...
      `,
      input: `
        group-data-[has-overlay]:!caret-$colorTemperature-700
        dark:group-data-[has-overlay]:!caret-$colorTemperature-300
      `,
    },
